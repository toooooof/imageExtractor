...
public class Extractor {
    ...
    public static void printHelp() {
        ...
        System.out.println("\n    --background-color <RRGGBB> : Expected background color. Overrides top lines scanning.");
    ...
    public static Conf parseOptions(String[] args) {
        ...
        for (int i = 0 ; i < (args.length - 1) / 2 ; i++) {
            ...
            switch (k) {
                case "--tolerance":
                    conf.setTolerance(Integer.valueOf(v));
                    break;
                case "--min-zone-size":
                    conf.setMinZoneSize(Integer.valueOf(v));
                    break;
                case "--nb-lines-reference":
                    conf.setNbLinesReference(Integer.valueOf(v));
                    break;
                case "--search-boundaries-percentage":
                    conf.setSearchBoundariesPercentage(Double.valueOf(v));
                    break;
                ...
                case "--output-files":
                    ...
                    break;
                case "--expected-zones":
                    conf.setExpectedElements(Integer.valueOf(v));
