...
class ImageOutline {
    ...
    public static void main(String[] args) throws Exception {
        final BufferedImage outline = ImageIO.read(new File("scanBlue.jpg"));
        BufferedImage crop = outline.getSubimage(17, 35, 420, 570);
...
//        BufferedImage crude = createAndWrite(crop, Color.white, false, 60, "motorcycle-02.png");
        BufferedImage crude = createAndWrite(crop, new Color(34, 160, 210), false, 30, "motorcycle-02.png");
